...
- (void)setShowsTomorrow:(BOOL)showsTomorrow {
    CGPoint offset = self.leftCal.timeView.contentOffset;
    ...
    self.leftCal.timeView.contentOffset = offset;
...
- (void)setDate:(NSDate *)date {
    ...
    if(self.pagingView) {
        ...
        if(!self.leftCal) {
            ...
            leftCal.timeView.delegate = self;
            centerCal.timeView.delegate = self;
            rightCal.timeView.delegate = self;
...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView {
    if(scrollView == self.leftCal.timeView || scrollView == self.centerCal.timeView || scrollView == self.rightCal.timeView) {
        CGPoint offset = scrollView.contentOffset;
        self.leftCal.timeView.contentOffset = offset;
        self.centerCal.timeView.contentOffset = offset;
        self.rightCal.timeView.contentOffset = offset;
    }
}
