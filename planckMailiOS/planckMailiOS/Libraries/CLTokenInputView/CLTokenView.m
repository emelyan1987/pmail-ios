...
- (id)initWithToken:(CLToken *)token font:(nullable UIFont *)font
{
    ...
    if (self) {
        UIColor *tintColor = [UIColor colorWithRed:1 green:0.4941 blue:0.9843 alpha:1.0];
        ...
        self.label.textColor = [UIColor whiteColor];//tintColor;
        ...
        if(self.type == 1 || self.type == 2)
            self.backgroundColor = CONTACT_BG_COLOR_1;
        else if(self.type == 3)
            self.backgroundColor = CONTACT_BG_COLOR_3;
        else
            self.backgroundColor = CONTACT_BG_COLOR_4;
...
- (id)initWithToken:(CLToken *)token font:(nullable UIFont *)font type:(NSInteger)type
{
    self = [super initWithFrame:CGRectZero];
    if (self) {
        UIColor *tintColor = [UIColor colorWithRed:1 green:0.4941 blue:0.9843 alpha:1.0];
